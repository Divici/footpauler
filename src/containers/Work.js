...
const Work = () => {
  return (
    <div>
      <h2 className="head-text pt-10">I Know that <span className='text-secondary'>Good Coaches</span> <br />make  <span className='text-secondary'>Passionate Players</span></h2>
